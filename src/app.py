...
activities = {
    ...
    "Soccer Team": {
        "description": "Competitive soccer team practicing for matches and tournaments",
        "schedule": "Mondays and Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 25,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Pickup games, skill drills, and friendly competitions",
    ...
    "Drama Club": {
        "description": "Theater rehearsals, stagecraft, and seasonal performances",
